...
class CLSHierarchicalMaxNetworks(nn.Module):
    def __init__(self, sentence_hidden_size, embedding_size, num_classes):
        super(CLSHierarchicalMaxNetworks, self).__init__()
    ...
    def forward(self, x):
        ...
        document_vector = sent_gru_out.max(1).values # Mean across the sentences
        sentence_attn = 0
