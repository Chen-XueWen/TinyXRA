...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="meta-llama/Llama-3.2-1B-Instruct")
    ...
    wandb.init(
        name="Llama3.2_1B_lr5e-4" + f"_{args.test_year}" + f"_S{args.seed}",
        project=args.project + f"_{args.risk_metric}",
        notes="Fine-tune head on Llama-3.2 with per-epoch eval",
    )
